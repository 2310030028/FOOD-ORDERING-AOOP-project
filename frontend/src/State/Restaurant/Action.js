...
export const getRestaurantById = (reqData) => {
    return async (dispatch) => {
      ...
      try {
        ...
        console.log({type:GET_RESTAURANT_BY_ID_FAILURE,payload:error});
      }
    };
};
...
export const updateRestaurant = ({ restaurantId, restaurantData, jwt }) => {
    return async (dispatch) => {
      ...
      try {
        ...
        // consol   e.log("Updated restaurant:", res.data);
        dispatch({ type: UPDATE_RESTAURANT_STATUS_SUCCESS, payload: res.data });
      } catch (error) {
        // console.log("Error occurred:", error);
        dispatch({ type: UPDATE_RESTAURANT_STATUS_FAILURE });
      }
    };
};
...
export const deleteRestaurant = (restaurantId, jwt) => {
    return async (dispatch) => {
      ...
      try {
        ...
        console.log("Restaurant deleted successfully!",res.data);
...
export const getAllEvents = ({jwt}) => {
    return async (dispatch) => {
      ...
      try {
        ...
        dispatch({ type: GET_ALL_EVENTS_FAILURE });
      }
    };
};
...
export const getRestaurantEvents = (restaurantId, jwt) => {
    return async (dispatch) => {
      ...
      try {
        ...
        console.log("Restaurant events fetched:", res.data);
        dispatch({ type: GET_RESTAURANTS_EVENTS_SUCCESS, payload: res.data });
      } catch (error) {
        console.log("Error while fetching restaurant events:", error);
...
export const getRestaurantsCategory = ({jwt,restaurantId}) => {
    return async (dispatch) => {
      ...
      try {
        ...
        console.log("Error while fetching restaurant categories: ", error);
